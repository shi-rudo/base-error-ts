...
hero:
  ...
  tagline: A cross-environment base error class for TypeScript — Node.js, browsers and edge runtimes. Structured errors, RFC 9457 Problem Details, and a public projection that never leaks internal state by default.
  actions:
    - theme: brand
      text: Get Started
